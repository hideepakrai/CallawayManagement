import {
  ...
  useSize_default,
  useToken
} from "./chunk-SUOUG7TH.js";
import {
  _asyncToGenerator,
  init_asyncToGenerator
} from "./chunk-2VLCRO3F.js";
import {
...
import {
  ...
  warning,
  warning_default
} from "./chunk-UHLRJ72D.js";
import {
  _defineProperty,
  init_defineProperty
} from "./chunk-NDUAGQTY.js";
import {
  _typeof,
  init_typeof
} from "./chunk-WNGVKCXJ.js";
import {
  require_classnames
} from "./chunk-VDHVM6YR.js";
import {
  _extends
} from "./chunk-CDGJA232.js";
import {
  require_react_dom
} from "./chunk-NSQOBVPG.js";
import {
  require_react
...
var InternalCompoundedButton = import_react8.default.forwardRef((props, ref) => {
  var _a, _b, _c;
  const {
    loading = false,
    prefixCls: customizePrefixCls,
  ...
  const disabled = (0, import_react8.useContext)(DisabledContext_default);
  const mergedDisabled = customDisabled !== null && customDisabled !== void 0 ? customDisabled : disabled;
  const groupSize = (0, import_react8.useContext)(GroupSizeContext);
  const loadingOrDelay = (0, import_react8.useMemo)(() => getLoadingConfig(loading), [loading]);
  const [innerLoading, setLoading] = (0, import_react8.useState)(loadingOrDelay.loading);
  const [hasTwoCNChar, setHasTwoCNChar] = (0, import_react8.useState)(false);
  const internalRef = (0, import_react8.createRef)();
  const buttonRef = composeRef(ref, internalRef);
  const needInserted = import_react8.Children.count(children) === 1 && !icon && !isUnBorderedButtonType(mergedType);
  ...
  const iconNode = icon && !innerLoading ? import_react8.default.createElement(IconWrapper_default, {
    prefixCls,
    className: iconClasses,
    style: iconStyle
  }, icon) : import_react8.default.createElement(LoadingIcon_default, {
    existIcon: !!icon,
    prefixCls,
  ...
  if (linkButtonRestProps.href !== void 0) {
    return wrapCSSVar(import_react8.default.createElement("a", Object.assign({}, linkButtonRestProps, {
  ...
  let buttonNode = import_react8.default.createElement("button", Object.assign({}, rest, {
    type: htmlType,
    className: classes,
    style: fullStyle,
    onClick: handleClick,
    ...
    ref: buttonRef
  }), iconNode, kids, !!compactItemClassnames && import_react8.default.createElement(compactCmp_default, {
    key: "compact",
    prefixCls
  }));
  if (!isUnBorderedButtonType(mergedType)) {
    buttonNode = import_react8.default.createElement(wave_default, {
      component: "Button",
...
var useTransitionDuration = function useTransitionDuration2() {
  var pathsRef = (0, import_react9.useRef)([]);
  var prevTimeStamp = (0, import_react9.useRef)(null);
...
var Tooltip_default = (0, import_react10.forwardRef)(Tooltip);
...
var zIndexContext = import_react11.default.createContext(void 0);
if (true) {
...
function useZIndex(componentType, customZIndex) {
  ...
  const parentZIndex = import_react12.default.useContext(zindexContext_default);
...
var InternalTooltip = React37.forwardRef((props, ref) => {
  var _a, _b;
  const {
    prefixCls: customizePrefixCls,
    openClassName,
  ...
  const child = React37.isValidElement(children) && !isFragment(children) ? children : React37.createElement("span", null, children);
...
var Circle3 = (props) => {
  ...
  const node = React38.createElement("div", {
...
var Line3 = (props) => {
  ...
  const lineInner = React39.createElement("div", {
    className: `${prefixCls}-inner`,
    style: trailStyle
  }, React39.createElement("div", {
    className: (0, import_classnames19.default)(`${prefixCls}-bg`, `${prefixCls}-bg-${infoPosition}`),
    style: percentStyle
  }, infoPosition === "inner" && children), successPercent !== void 0 && React39.createElement("div", {
    className: `${prefixCls}-success-bg`,
    style: successPercentStyle
  }));
  const isOuterStart = infoPosition === "outer" && infoAlign === "start";
  const isOuterEnd = infoPosition === "outer" && infoAlign === "end";
  return infoPosition === "outer" && infoAlign === "center" ? React39.createElement("div", {
    className: `${prefixCls}-layout-bottom`
  }, lineInner, children) : React39.createElement("div", {
...
var Steps = (props) => {
  ...
  for (let i = 0; i < steps; i++) {
    ...
    styledSteps[i] = React40.createElement("div", {
      key: i,
      className: (0, import_classnames20.default)(`${prefixCls}-steps-item`, {
...
var Progress = React41.forwardRef((props, ref) => {
  ...
  const strokeColorIsBright = React41.useMemo(() => {
  ...
  const progressInfo = React41.useMemo(() => {
    ...
    return React41.createElement("span", {
      className: (0, import_classnames21.default)(`${prefixCls}-text`, {
  ...
  const classString = (0, import_classnames21.default)(prefixCls, `${prefixCls}-status-${progressStatus}`, {
...
var ListItem = React42.forwardRef((_ref, ref) => {
  ...
  if (listType === "picture" || listType === "picture-card" || listType === "picture-circle") {
    if (mergedStatus === "uploading" || !file.thumbUrl && !file.url) {
      const uploadingClassName = (0, import_classnames22.default)(`${prefixCls}-list-item-thumbnail`, {
      ...
      const aClassName = (0, import_classnames22.default)(`${prefixCls}-list-item-thumbnail`, {
  ...
  const listItemClassName = (0, import_classnames22.default)(`${prefixCls}-list-item`, `${prefixCls}-list-item-${mergedStatus}`);
  ...
  const downloadOrDelete = listType !== "picture-card" && listType !== "picture-circle" && React42.createElement("span", {
    key: "download-delete",
    className: (0, import_classnames22.default)(`${prefixCls}-list-item-actions`, {
      picture: listType === "picture"
    })
  }, downloadIcon, removeIcon);
  const listItemNameClass = (0, import_classnames22.default)(`${prefixCls}-list-item-name`);
  ...
  const dom = React42.createElement("div", {
    ...
    return React42.createElement("div", {
      className: (0, import_classnames22.default)(`${prefixCls}-list-item-progress`, motionClassName)
    }, loadingProgress);
  }));
  ...
  return React42.createElement("div", {
    className: (0, import_classnames22.default)(`${prefixCls}-list-item-container`, className),
    style,
    ref
...
var InternalUploadList = (props, ref) => {
  ...
  const actionIconRender = (customIcon, callback, prefixCls2, title, acceptUploadDisabled) => {
    const btnProps = {
      ...
      onClick: (e) => {
        var _a, _b;
        callback();
        if (React43.isValidElement(customIcon)) {
  ...
  const rootPrefixCls = getPrefixCls();
  const listClassNames = (0, import_classnames23.default)(`${prefixCls}-list`, `${prefixCls}-list-${listType}`);
  ...
  return React43.createElement("div", {
    ...
    return cloneElement(appendAction, (oriProps) => ({
      className: (0, import_classnames23.default)(oriProps.className, motionClassName),
...
var InternalUpload = (props, ref) => {
  ...
  const wrapRef = React44.useRef(null);
  if (true) {
  ...
  const mergedCls = (0, import_classnames24.default)(wrapperCls, className, rootClassName, hashId, cssVarCls, ctxUpload === null || ctxUpload === void 0 ? void 0 : ctxUpload.className, {
    [`${prefixCls}-rtl`]: direction === "rtl",
  ...
  if (type === "drag") {
    const dragCls = (0, import_classnames24.default)(hashId, prefixCls, `${prefixCls}-drag`, {
  ...
  const uploadButtonCls = (0, import_classnames24.default)(prefixCls, `${prefixCls}-select`, {
    [`${prefixCls}-disabled`]: mergedDisabled
  });
...
var Dragger = React45.forwardRef((_a, ref) => {
  var {
    style,
    height,
    hasControlInside = false
  } = _a, restProps = __rest6(_a, ["style", "height", "hasControlInside"]);
  return React45.createElement(Upload_default2, Object.assign({
    ref,
    hasControlInside
  }, restProps, {
    type: "drag",
...
//# sourceMappingURL=chunk-H354HXW6.js.map
