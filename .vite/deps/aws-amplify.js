import {
  ...
  urlSafeDecode
} from "./chunk-CZG7O2O2.js";
import "./chunk-ZQZUO572.js";
import {
  __commonJS,
  __esm,
  __export,
...
var getHashFromData = (data) => {
  const sha256 = new import_sha256_js.Sha256();
  sha256.update(data);
...
var import_sha256_js2 = __toESM(require_build2(), 1);
var getHkdfKey = (ikm, salt, info) => {
  const awsCryptoHash = new import_sha256_js2.Sha256(salt);
  awsCryptoHash.update(ikm);
  const resultFromAWSCryptoPrk = awsCryptoHash.digestSync();
  const awsCryptoHashHmac = new import_sha256_js2.Sha256(resultFromAWSCryptoPrk);
...
var import_sha256_js3 = __toESM(require_build2(), 1);
...
var import_sha256_js4 = __toESM(require_build2(), 1);
var getSignatureString = ({ userPoolName, username, challengeParameters, dateNow, hkdf }) => {
  ...
  const awsCryptoHash = new import_sha256_js4.Sha256(hkdf);
...
var import_sha256_js5 = __toESM(require_build2(), 1);

// node_modules/@aws-amplify/auth/dist/esm/providers/cognito/apis/signOut.mjs
var import_sha256_js6 = __toESM(require_build2(), 1);
