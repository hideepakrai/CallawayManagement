...
const exportOgioProductsToExcel = ({ resetExportAll }: Props)  => {

    //getTravisProducts
    const alldata = useSelector(getOgioProducts) as OgioBasicModel[];
...
export default exportOgioProductsToExcel;
