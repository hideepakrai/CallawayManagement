...
type Props = {
    selectedRow:BasicModelGoods [];
    resetSelectedRow: () => void;
  };
  
  
  const HardGoodsPdf: React.FC<Props> = ({ selectedRow, resetSelectedRow }: Props) => {
              ...
              <Col xs={24} >
                ...
                <Card id="catelog" ref={contentToPrint}>
                    ...
                    <div className='mb-18' style={{ textAlign: 'center', height: "1122px", backgroundColor: "#000", paddingTop: "300px" }}>
                      ...
                      <h2 className='brand-title'  style={{ paddingTop: "40px", paddingBottom: "40px", fontSize: "45px", color: "#fff", fontWeight: "500", letterSpacing: "4px", }}>Hardgoods</h2>
