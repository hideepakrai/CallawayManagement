...
// import { getApparelNote, getApparelProducts, getPreOrderId, getSoftgoodRetailerDetail } from '../../../slice/allProducts/CallAwayGoodsSlice'
...
//   const [alldata, setAllData] = useState<BasicModelGoods[]>([])
...
//                 <p className="gx-mb-0  text-black font-weight-800 fw-semibold fs-4"><span className="text-black font-weight-800 text-gray-600 fw-semibold fs-5">Date:</span> {orderDate} </p>
...
//                 <p className="gx-mb-0  text-black font-weight-800 fw-semibold fs-4"><span className="text-black font-weight-800 text-gray-600 fw-semibold fs-5">Manager:</span> {managerName}
//                 </p>
//                 <p className="gx-mb-0  text-black font-weight-800 fw-semibold fs-4"><span className="text-black font-weight-800 text-gray-600 fw-semibold fs-5">Sales Rep:</span> {recordPdf.salesrep_name}
//                 </p>
//               </div>
//             </div>
